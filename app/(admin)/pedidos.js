              ...
              <View style={styles.modalSection}>
                ...
                {(pedido.itens || []).map((item, i) => (
                  <View key={i} style={styles.itemRow}>
                    ...
                    <Text style={styles.itemPrice}>
                      R$ {Number(item.precoTotal || 0).toFixed(2)}
                    </Text>
                  </View>
                ))}
                ...
                <View style={styles.itemRow}>
                  ...
                  <Text style={styles.totalValue}>
                    R$ {Number(pedido.precoTotal || pedido.valorTotal || 0).toFixed(2)}
                  </Text>
                </View>
              </View>
                  ...
                  <View style={styles.statusChips}>
                    {ALL_STATUS.map(s => (
                      <TouchableOpacity
                        ...
                        style={[
                          styles.statusChip,
                          pedido.statusPedido === s && styles.statusChipActive,
                        ]}
                      ...
                      >
                        <Text style={[
                          ...
                          pedido.statusPedido === s && styles.statusChipTextActive,
                        ]}>
    ...
    <View style={styles.container}>
      <View style={styles.pageHeader}>
        <View>
          ...
          <Text style={styles.pageSubtitle}>{totalElements} pedidos no total</Text>
        </View>
            ...
            pedidos.map((p, i) => (
              ...
              >
                ...
                <Text style={[styles.td, { flex: 1 }]}>
                  R$ {Number(p.precoTotal || 0).toFixed(2)}
                </Text>
                ...
                <TouchableOpacity
                  style={[styles.detailBtn, { flex: 0.8 }]}
                  onPress={() => openModal(p.id)}
                >
...
const styles = StyleSheet.create({
  ...
  th: { fontSize: 12, fontWeight: '600', color: colors.textMuted, textTransform: 'uppercase' },
  tableRow: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingHorizontal: spacing.lg,
  ...
  modalInfoSub: { fontSize: 13, color: colors.textSecondary },
  itemRow: {
